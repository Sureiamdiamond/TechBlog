...
Map homePagePosterMap = {
  ...
  "writer": "ملیکا عزیزی",
  "date": "یک روز پیش",
  "title": "دوازده قدم برای برنامه نویسی یک دوره ی ... ",
  "view": "251",
};
...
List<HashTagModel> tagList = [
  ...
  HashTagModel(title: "کاتلین"), //index 1
...
List<PodcastModel> podcastlist = [
  PodcastModel(
      imageUrl:
          "https://cheyab.ir/wp-content/uploads/digesttt-podcast-1024x1024.jpg",
      title: "Digesttt",
      views: "439"),
  PodcastModel(
      imageUrl: "https://cheyab.ir/wp-content/uploads/navcast-1024x1024.png",
      title: "NavCast",
      views: "287"),
  PodcastModel(
      imageUrl: "https://cheyab.ir/wp-content/uploads/bplus-1024x1024.png",
      title: "BPlus",
      views: "934")
];
